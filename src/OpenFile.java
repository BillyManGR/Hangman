...
public class OpenFile {
	...
	public String chooseWord(String fileName){
		...
		try {
			...
			if(word.equals("NONE")) word= sc.nextLine();
			sc.close();
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	/**
	 * Function found in the Internet
	 * Relative performance:
	 * "s. On a 150MB log file this takes 0.35 seconds, 
	 * versus 2.40 seconds when using readLines()"
	 * @param filename
	 * @return
	 * @throws IOException
	 */
